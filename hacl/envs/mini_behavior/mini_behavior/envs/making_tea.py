...
class MakingTeaGenEnv(RoomGrid):
    """
    Environment in which the agent is instructed to clean a car
    """
    ...
    def __init__(
        ...
        num_objs = {'teapot': 1, 'tea_bag': 1, 'lemon': 1, 'knife': 1, 
                    'cabinet': 1, 'electric_refrigerator': 1, 'stove': 1, 'apple': 1}
        self.mission = 'make tea'
...
# non human input env
register(
    id='MiniGrid-MakingTea-Basic-12x12-N2-v0',
    entry_point='hacl.envs.mini_behavior.mini_behavior.envs:MakingTeaEnv'
)

register(
    id='MiniGrid-MakingTea-Gen-12x12-N2-v0',
    entry_point='hacl.envs.mini_behavior.mini_behavior.envs:MakingTeaGenEnv'
)
