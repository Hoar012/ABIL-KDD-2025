...
class CleaningACarEnv(RoomGrid):
    ...
    def __init__(
        ...
        # num_objs = {'car': 1, 'rag': 1, 'shelf': 1, 'soap': 1, 'bucket': 1, 'sink': 1, "towel": 1}
...
class CleaningACarGenEnv(RoomGrid):
    """
    Environment in which the agent is instructed to clean a car
    """
...
# non human input env
register(
    id='MiniGrid-CleaningACar-Basic-12x12-N2-v0',
    entry_point='hacl.envs.mini_behavior.mini_behavior.envs:CleaningACarEnv'
)
register(
    id='MiniGrid-CleaningACar-Gen-12x12-N2-v0',
    entry_point='hacl.envs.mini_behavior.mini_behavior.envs:CleaningACarGenEnv'
)
