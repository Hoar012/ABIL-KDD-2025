...
class ModelFull(pds.mini_nn.PDSketchMBRLModel):
    def init_networks(self, domain):
        ...
        for k in ['is-printer', 'is-table', 'is-package','is-shelf', 'toggleon', 'is-open', 'is-book',
                  ...
                  "is-stove", "is-marker", "is-pan", "is-electric_refrigerator"]:
