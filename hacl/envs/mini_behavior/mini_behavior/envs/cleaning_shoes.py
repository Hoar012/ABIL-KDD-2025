...
class CleaningShoesEnv(RoomGrid):
    ...
    def __init__(
        ...
        num_objs = {'soap': 1, 'bed': 1, 'rag': 1, 'towel': 1, 'shoe': 2, 'sink': 1}
        #num_objs = {'soap': 1, 'bed': 1, 'rag': 1, 'towel': 1, 'shoe': 2, 'sink': 1, 'sock': 1}
    ...
    def _end_conditions(self):
        ...
        return towel.check_abs_state(self, 'onfloor'), score
    
class CleaningShoesGenEnv(RoomGrid):
    """
    Environment in which the agent is instructed to clean a car
    """
...
# non human input env
register(
    id='MiniGrid-CleaningShoes-Basic-10x10-N2-v0',
    entry_point='hacl.envs.mini_behavior.mini_behavior.envs:CleaningShoesEnv'
)

register(
    id='MiniGrid-CleaningShoes-Gen-10x10-N2-v0',
    entry_point='hacl.envs.mini_behavior.mini_behavior.envs:CleaningShoesGenEnv'
)