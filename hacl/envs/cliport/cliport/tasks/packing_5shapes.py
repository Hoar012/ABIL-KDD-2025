...
class Packing5Shapes(Task):
    ...
    def __init__(self):
        ...
        self.train_set = np.arange(0, 5)
        self.test_set = np.arange(0, 5)
    ...
    def reset(self, env):
        ...
        self.objs_id[container_id] = "container"
        ...
        for i in range(n_objects):
            ...
            self.objs_id[block_id] = shape_names[shape]
        ...
        for i in range(num_objects_to_pick):
            ...
            self.goal_predicates = [shape_names[obj_shapes[i]]]
